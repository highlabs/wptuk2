...
function html5blank_header_scripts()
{
    if (!is_admin()) {
        ...
        wp_register_script('tuktukjs', get_template_directory_uri() . '/js/tuktuk.js', array(), '1.0.0'); // Tuktuk JS
        wp_enqueue_script('tuktukjs'); // Enqueue it!
    }
}
...
function html5blank_styles()
{
    ...
    wp_register_style('tuktukicons', get_template_directory_uri() . '/css/tuktuk.icons.css', array(), '1.0.0'); // Tuktuk Icons CSS
    wp_enqueue_style('tuktukicons'); // Enqueue it!
    wp_register_style('tuktuktheme', get_template_directory_uri() . '/css/tuktuk.theme.css', array(), '1.0.0'); // TuktukTheme
    wp_enqueue_style('tuktuktheme'); // Enqueue it!
}
...
?>
	...
	<?php printf(__('<cite class="fn text bold">%s</cite> <span class="says">says:</span>'), get_comment_author_link()) ?>
	</div>
...
<?php endif; ?>
	...
	<div class="text italic comment-meta commentmetadata"><a href="<?php echo htmlspecialchars( get_comment_link( $comment->comment_ID ) ) ?>">
		<?php
